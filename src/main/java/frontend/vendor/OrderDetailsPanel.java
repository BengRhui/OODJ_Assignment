...
public class OrderDetailsPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        orderIDText.setText(currentOrder.getOrderID() + " - " + currentOrder.getDiningType().toString() + (currentOrder.getTableNumber() == null || currentOrder.getTableNumber().equals("-") ? "" : String.format(" (%s)", currentOrder.getTableNumber())));
