 ...
 * @author jack
 */
public class LoginPageJack extends javax.swing.JFrame {

    /**
     * Creates new form MainPage
     */
    public LoginPageJack() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginPageJack.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginPageJack().setVisible(true);
            }
        });
    }
